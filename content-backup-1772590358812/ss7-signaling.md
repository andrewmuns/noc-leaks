...
> **💡 NOC Tip:** e in-band vs. out-of-band distinction survives in SIP. SIP signaling (INVITE, BYE, etc.) travels separately from RTP media. When you're troubleshooting, always analyze signaling and media independently — a call can have perfect signaling but broken media, or vice versa.
