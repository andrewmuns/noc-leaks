...
> **💡 NOC Tip:** ways baseline your quality metrics. Know what "normal" MOS looks like for different call types: internal calls should be 4.3+, PSTN calls 4.0+, international calls 3.8+, WebRTC calls vary more. Without a baseline, you can't distinguish a real problem from normal variation. Set alerts at thresholds that are meaningful for each call type.
