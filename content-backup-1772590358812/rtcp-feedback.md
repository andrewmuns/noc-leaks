...
> **💡 NOC Tip:** r G.711, jitter values above 50ms indicate network congestion. Values above 150ms cause noticeable quality degradation. Values above 300ms make VoIP unusable.
slug: "rtcp-feedback"
---
...
> **💡 NOC Tip:** lnyx voice quality dashboards use RTCP-XR data when available. If you see "N/A" for some calls, the endpoint doesn't support RTCP-XR. Legacy equipment often lacks this feature.
slug: "rtcp-feedback"
---
...
> **💡 NOC Tip:** e-way RTCP reports (only sender→receiver shows loss) often indicate asymmetric routing — a classic sign of NAT or firewall misconfiguration.
