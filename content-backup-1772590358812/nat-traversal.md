...
> **💡 NOC Tip:**  STUN is enabled on a device and calls still fail, check NAT type. Symmetric NAT breaks STUN-based NAT traversal every time. You'll need TURN relay for these cases.
...
> **💡 NOC Tip:** RN usage shows in your Telnyx console. If you see high TURN relay traffic for specific customers, they likely have Symmetric NAT or restrictive firewalls. Recommend SBC deployment or firewall changes to reduce relay costs.
slug: "nat-traversal"
---
...
> **💡 NOC Tip:** P ALG is a frequent culprit in "weird" call issues. If a customer through a specific router has inexplicable problems, recommend disabling SIP ALG. Modern SBCs and B2BUAs (like Telnyx uses) handle NAT properly without ALG assistance.
