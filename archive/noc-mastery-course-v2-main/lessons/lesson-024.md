# Lesson 24: Autonomous Systems and Internet Routing Fundamentals
**Module 1 | Section 1.6 — BGP**
**⏱ ~8min read | Prerequisites: Lesson 13**
---
...
🔧 **NOC Tip:** Bookmark https://bgp.he.net/AS46887 — it's the quickest way to see Telnyx's announced prefixes, peers, and upstream providers during an incident.
...
🔧 **NOC Tip:** When you see routing issues in the NOC, first determine: is the problem *internal* (IGP — our routers can't reach each other) or *external* (BGP — the internet can't reach us, or we can't reach a destination)? The tools and escalation paths are completely different.
...
🔧 **NOC Tip:** Longest prefix match is why more-specific route announcements can "hijack" traffic. If someone (accidentally or maliciously) announces `64.16.5.0/24` and we only announce `64.16.0.0/20`, their more-specific route wins. This is a BGP hijack — covered in Lesson 25.
...
🔧 **NOC Tip:** Regional reachability problems almost always point to BGP. If the issue is geography-specific, start with BGP tools — not ping and traceroute from your own desk (you're likely in a US data center with great connectivity).
