# Lesson 10: Opus — The Modern Codec and Why It Won
**Module 1 | Section 1.2 — Digital Voice: Sampling, Quantization, and Codecs**
**⏱ ~6 min read | Prerequisites: Lesson 7**
...
🔧 **NOC Tip:** Unlike legacy SIP codecs where you negotiate once and the bitrate is fixed, Opus in WebRTC continuously adapts. This means quality metrics aren't constant throughout a call. When analyzing WebRTC call quality in Grafana, look at bitrate *over time*, not just averages. A call with an average bitrate of 30 kbps might have spent half its duration at 50 kbps and half at 10 kbps — the average hides the poor periods.
