# Lesson 33: DTMF — RFC 2833/4733 Telephone Events vs. In-Band Detection
**Module 1 | Section 1.8 — RTP and RTCP: Voice/Video over IP**
...
🔧 **NOC Tip:** If a customer reports "IVR not recognizing digits" and they're using G.729, in-band DTMF is your first suspect. Check the SDP negotiation — are telephone-events being negotiated?
...
🔧 **NOC Tip:** When debugging DTMF issues, always check **both legs** of the B2BUA independently. The customer leg might negotiate RFC 4733 perfectly while the carrier leg has a mismatch.
...
🔧 **NOC Tip:** If automated systems (calling card platforms, IVR-to-IVR bridges) report missed digits, check the inter-digit gap. Automated systems often send digits faster than human fingers, pushing below the detection threshold.
