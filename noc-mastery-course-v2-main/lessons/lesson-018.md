# Lesson 18: TCP — Reliability, Congestion Control, and SIP over TCP/TLS

**Module 1 | Section 1.4 — Protocol Stack**
**⏱ ~8 min read | Prerequisites: Lesson 15**
...
🔧 **NOC Tip:** Monitor TCP retransmissions on SIP connections. `ss -ti` shows per-connection retransmission counts on Linux. Rising retransmissions correlate with network loss and manifest as increased SIP latency and timeouts. This is often an early warning sign before call quality degrades.
