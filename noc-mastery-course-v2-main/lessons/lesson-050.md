# Lesson 50: SDP Structure — Offer/Answer Model
**Module 1 | Section 1.12 — SDP and Media Negotiation**
**⏱ ~8 min read | Prerequisites: Lesson 44**
...
🔧 **NOC Tip:** When debugging audio issues, always check the `c=` line and the port in the `m=` line first. These tell you where media *should* go. If they contain private IPs but the endpoint is behind NAT, you've found your problem.
