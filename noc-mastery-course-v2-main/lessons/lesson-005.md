# Lesson 5: Number Lookup and Caller Identity (CNAM)

**Module 1 | Section 1.18 — Identity**
**⏱ ~5min read | Prerequisites: Lesson 42 (Number Portability)**
...
🔧 **NOC Tip:** Before troubleshooting SMS delivery failures, always check line type. About 15% of "SMS not delivered" tickets are simply messages sent to landlines. A quick number lookup saves 20 minutes of investigation.
...
🔧 **NOC Tip:** When investigating widespread routing issues to a specific carrier, batch lookup a sample of affected numbers. If they all show the same carrier and porting status, the issue is likely on that carrier's side.
