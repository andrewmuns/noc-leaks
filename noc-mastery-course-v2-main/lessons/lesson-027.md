# Lesson 27: BGP Incidents — Hijacks, Leaks, and Troubleshooting

**Module 1 | Section 1.6 — BGP**
**⏱ ~7 min read | Prerequisites: Lessons 23, 24**
...
🔧 **NOC Tip:** If you see traffic to your prefixes suddenly routing through an unexpected AS, check bgp.he.net immediately. A sudden upstream change during stable operations is a red flag.
...
🔧 **NOC Tip:** Route leaks often manifest as latency spikes on specific paths, not total outages. If traceroutes show traffic taking weird detours (EU traffic routing through Asia-Pacific), investigate for route leaks.
...
🔧 **NOC Tip:** You can check your prefix RPKI status at [rpki-validator.ripe.net](https://rpki-validator.ripe.net). Make sure Telnyx's critical prefixes are covered by valid ROAs.
...
🔧 **NOC Tip:** When investigating reachability issues:
