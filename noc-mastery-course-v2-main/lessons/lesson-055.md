# Lesson 55: End-to-End vs Hop-by-Hop Encryption
**Module 1 | Section 1.14 — Security**
**⏱ ~5min read | Prerequisites: Lesson 52**
---
...
🔧 **NOC Tip:** When a customer asks "is my call encrypted end-to-end through Telnyx?" — the honest answer is **no, it's hop-by-hop**. Media is encrypted on the wire between each hop, but Telnyx SBCs have access to plaintext media for processing. This is standard for all carrier-grade VoIP platforms. The media is encrypted in transit, but decrypted at each processing point.
