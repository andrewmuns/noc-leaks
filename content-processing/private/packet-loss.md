...
objectives:
- "Understand Burst loss is far more damaging than random loss at the same percentage\
  \ \u2014 always examine the loss pattern, not just the aggregate rate"
- Understand Common causes: congestion (queue overflow), firewall timeouts, MTU/fragmentation
    issues, wireless interference, and rate policing
- "Understand RTCP reports aggregate loss but can't distinguish random vs. burst or\
  \ network loss vs. late arrivals \u2014 use PCAPs for detailed analysis"
- Understand Loss impact is non-linear: 1% is barely noticeable, 5% is clearly annoying,
    10% is very poor
- "Understand Asymmetric loss (different in each direction) is common due to asymmetric\
  \ routing \u2014 always check both directions"
public_word_count: 300
slug: packet-loss
title: "Packet Loss \u2014 Causes, Effects, and Measurement"
total_word_count: 339
---
