...
This is arguably the most important provisional response for VoIP. 183 with an SDP body establishes *early media* — a media path before the call is answered. This is how you hear ringback tones, announcements ("the number you have dialed..."), and IVR prompts from the far end before answer.
