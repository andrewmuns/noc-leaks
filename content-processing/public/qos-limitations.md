...
> **💡 NOC Tip:** en troubleshooting call quality, always verify DSCP markings in packet captures. Look at the IP header's DSCP field. If voice packets are marked as Best Effort (DSCP 0) instead of EF (DSCP 46), that's a strong clue — they're getting
